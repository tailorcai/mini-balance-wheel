...
5       MCPWM_UNIT_1          4                5
*/
void McpwmMotor::attachMotor(uint8_t id, uint8_t gpioIn1, uint8_t gpioIn2)
{
...
void McpwmMotor::stopMotor(int8_t motorId)
{
}

void McpwmMotor::updateMotorSpeed(int8_t id, int16_t pwmValue)
{
    mcpwm_unit_t mcpwm_num = MCPWM_UNIT_0;
    if (id / 3 == 1)
    {
